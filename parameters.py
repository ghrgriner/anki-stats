# Parameters for `anki_stats.py` that can be set by the user
...
However, this parameter file isn't used for example_add_fields_to_notes.py.
In the latter case, the parameters are edited in the file itself.
"""
